...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            Document doc1 = new Document("_id", doc.getObjectId("_id"));
            Document doc2 = new Document("imdb.rating", rating);
            return new UpdateOneModel<Document>(
                    doc1,
                    new Document("$set", doc2));
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220student@suportereader.h37dd.mongodb.net/mfilx?retryWrites=true&w=majority";
